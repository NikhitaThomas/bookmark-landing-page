...
function Footer() {
  return (
    <div className="p-10 bg-indigo-950 text-white flex flex-col md:flex-row justify-between items-center gap-10">
      <div className="flex flex-col md:flex-row gap-10 items-center">
        ...
        <div className="hover:text-red-500">Features</div>
        <div className="hover:text-red-500">Pricing</div>
